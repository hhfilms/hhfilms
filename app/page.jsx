    ...
    <div className="w-full">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8  w-full bg-main-950">
        <div className="flex flex-col sm:flex-row items-center">
          <h2 className="text-4xl font-assistant sm:text-5xl mb-4 flex-grow text-brand">heart</h2>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 w-full bg-main-900">
        <div className="flex flex-col sm:flex-row items-center">
          <h2 className="text-4xl font-assistant  sm:text-5xl mb-4 flex-grow text-brand">hustle</h2>
